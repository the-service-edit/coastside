...
def resources():
    ...
    hero = V7_RESOURCES_HERO(c, items) if 'V7_RESOURCES_HERO' in globals() else f'''<section class="hero dark"><div class="wrap">{crumbs(c, items)}<span class="eyebrow">Resources</span><h1>Straight answers for builders and site managers.</h1><p class="lead">Written from the job, reviewed by Steve. No filler.</p></div></section>'''
    body = hero + f'''
